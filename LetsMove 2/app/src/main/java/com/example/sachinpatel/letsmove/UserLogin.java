...
public class UserLogin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences.edit().remove("login_email");
        ...
        stopService(new Intent(UserLogin.this, NotificationService.class));
        stopService(new Intent(UserLogin.this, AcceptedService.class));
